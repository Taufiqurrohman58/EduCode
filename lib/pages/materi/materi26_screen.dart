...
class Materi26Screen extends StatefulWidget {
  const Materi26Screen({super.key});

  @override
  State<Materi26Screen> createState() => _Materi26ScreenState();
}

class _Materi26ScreenState extends State<Materi26Screen>
...
late Animation<double> _bounceAnim;
  ...
  /// PETUNJUK URUTAN
final List<int> hintOrder = [1, 2, 3];
...
onTap: () {
  ...
  final expectedQuestion = hintOrder[cursorIndex];

  if (index != expectedQuestion) {
    return;
  }

  if (text != correctAnswers[index]) {
    return;
  }
          ...
          ? Padding(
              ...
              child: Align(
                ...
                child: ElevatedButton(
                  onPressed: () async {
                    await DBHive.completeMateri(26);
