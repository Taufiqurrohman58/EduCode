...
class Materi16Screen extends StatefulWidget {
  const Materi16Screen({super.key});

  @override
  State<Materi16Screen> createState() => _Materi16ScreenState();
}


class _Materi16ScreenState extends State<Materi16Screen>
...
final List<HintStep> hintSteps = [
  // Row 0
  HintStep(color: Colors.blue, row: 0, col: 3),
  HintStep(color: Colors.yellow, row: 0, col: 4),

  // Row 1
  HintStep(color: Colors.pink, row: 1, col: 0),
  HintStep(color: Colors.orange, row: 1, col: 1),
  ...
  // Row 3
  HintStep(color: Colors.green, row: 3, col: 2),
  HintStep(color: Colors.yellow, row: 3, col: 5),
  ...
  // Row 5
  HintStep(color: Colors.green, row: 5, col: 4),
  HintStep(color: Colors.red, row: 5, col: 5),
];
...
final Map<Color, GlobalKey> colorKeys = {
  ...
  Colors.orange: GlobalKey(),
  Colors.pink: GlobalKey(),
  const Color(0xFF8B4513): GlobalKey(),
};
...
onTap: () {
  ...
  void _nextMateri() {
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(content: Text('Materi 17 berhasil terbuka!')),
    );
          ...
          ? Padding(
              ...
              child: Align(
                ...
                child: ElevatedButton(
                  onPressed: () async {
                    await DBHive.completeMateri(16);
