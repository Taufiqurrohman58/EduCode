...
class Level38Screen extends StatefulWidget {
  const Level38Screen({super.key});

  @override
  State<Level38Screen> createState() => _Level38ScreenState();
}

class _Level38ScreenState extends State<Level38Screen> {
  //responsive
  double scale = 1;
          ...
          ? Padding(
              ...
              child: Align(
                ...
                child: ElevatedButton(
                  onPressed: () async {
                    await DBHive.unlockNextLevel(38);
