...
class Level28Screen extends StatefulWidget {
  const Level28Screen({super.key});

  @override
  State<Level28Screen> createState() => _Level28ScreenState();
}

class _Level28ScreenState extends State<Level28Screen> {
  //responsive
  double scale = 1;
  ...
  final List<String> leftImages = [
    "assets/images/28/a1.png",
    "assets/images/28/a2.png",
    "assets/images/28/a3.png",
    "assets/images/28/a4.png",
  ];

  final List<String> rightImages = [
    "assets/images/28/b1.png",
    "assets/images/28/b2.png",
    "assets/images/28/b3.png",
    "assets/images/28/b4.png",
  ];
          ...
          ? Padding(
              ...
              child: Align(
                ...
                child: ElevatedButton(
                  onPressed: () async {
                    await DBHive.unlockNextLevel(28);
